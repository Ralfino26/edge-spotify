...
class MusicManager: ObservableObject {
    ...
    private func setActiveControllerBasedOnPreference() {
        ...
        // If NowPlaying is deprecated but that's the preference, fall back to Spotify
        ...
        } else if controllerType != .spotify, let fallbackController = createController(for: .spotify) {
            // Fallback to Spotify if preferred controller couldn't be created
